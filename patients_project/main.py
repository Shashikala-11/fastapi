...
class Patient(BaseModel):
    ...
    name:Annotated[str,Field(...,description='Name of the patient',examples=['Abhay','Ajay'])]
...
class PatientUpdate(BaseModel):
    name:Annotated[Optional[str],Field(...,description='Name of the patient',examples=['Abhay','Ajay'])]
...
def load_data():
    with open(r'patients.json','r') as f:
        data=json.load(f)
    return data    
...
def create_patient(patient:Patient):
    ...
    # new product add to the database
